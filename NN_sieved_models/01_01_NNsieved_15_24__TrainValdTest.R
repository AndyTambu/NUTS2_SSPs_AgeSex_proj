...
#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#
set.seed(860)                                    # <- Ensure reproducibility
#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#
...
# 20022025
# Groups:   hidden_units, activation, learn_rate [405]
# hidden_units activation learn_rate   rmse   rsq
# <dbl> <chr>           <dbl>  <dbl> <dbl>
#   1           10 elu            0.0848 0.0300 0.862
...
Sieve_fit_brulee_first_test_corct_funcs_15_24_test20022025_corrStu <- lapply(rand_samp,function(z){
...
#save(Sieve_fit_brulee_first_test_corct_funcs_15_24_test20022025_corrStu, file = './01_Age_Structure/AAA_longer_timeSeries/results/Sieve_fit_brulee_first_test_corct_funcs_15_24_test20022025_corrStu.RData')
load(file = './results/Sieve_fit_brulee_first_test_corct_funcs_15_24_test20022025_corrStu.RData')
lapply(Sieve_fit_brulee_first_test_corct_funcs_15_24_test20022025_corrStu, function(x) sapply(x, length))
...
ggplot(result_tbbl_15_24, aes(x = id)) +
...
# 
# result_tbbl %>% 
#   dplyr::mutate(se_test =  (row_median  - test_data$lag1_quot_15_24)^2) %>% 
#   # dplyr::group_by(cluster) %>% 
#   dplyr::summarise(rmse_test = sqrt(mean(se_test)),
#                    test_r2 = 1-(mean(se_test)/var(test_data$lag1_quot_15_24)))
# 
...
result_tbbl_rescaled <- 
  ...
  cbind(true_val = test_data$lag1_quot_15_24) %>% #the variable need to be changed according to the age group.
  cbind( ctry_prop = 
           test_data %>% 
           # dplyr::filter(age.group == 'under15') %>% 
           dplyr::select(ctry_prop_15_24) %>% pull()
  ) %>% 
