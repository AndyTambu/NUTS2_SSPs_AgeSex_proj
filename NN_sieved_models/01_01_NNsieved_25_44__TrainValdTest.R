...
Sieve_fit_brulee_first_test_corct_funcs_25_44_test20022025_corrStu <- lapply(rand_samp,function(z){
...
#save(Sieve_fit_brulee_first_test_corct_funcs_25_44_test20022025_corrStu, file = './results/Sieve_fit_brulee_first_test_corct_funcs_25_44_test20022025_corrStu.RData')
load(file = './results/Sieve_fit_brulee_first_test_corct_funcs_25_44_test20022025_corrStu.RData')
lapply(Sieve_fit_brulee_first_test_corct_funcs_25_44_test20022025_corrStu, function(x) sapply(x, length))
...
ggplot(result_tbbl_25_44, aes(x = id)) +
...
result_tbbl_rescaled <- 
  ...
  cbind(true_val = test_data$lag1_quot_25_44) %>% #the variable need to be changed according to the age group.
  cbind( ctry_prop = 
           test_data %>% 
           # dplyr::filter(age.group == 'under15') %>% 
           dplyr::select(ctry_prop_25_44) %>% pull()
  ) %>% 
